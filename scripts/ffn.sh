...
#Cosmic Tagger
APP_DATA_DIR=${DATA_DIR}/ffn_${FILE_INDEX}
...
cp /lus/theta-fs0/logs/darshan/theta/2020/8/1/*${COBALT_JOBID}* /home/dhari/darshan-logs/benchmark/ffn/optimization/${FILE_INDEX}.darshan
