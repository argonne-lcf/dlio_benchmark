...
for i in 0 1 2 4 8 16 32; do
  if [ "${i}" = "0" ]; then
    data_type=hdf5
    OPTS=(-f ${data_type} -fa shared -nf 1 -sf 3072000 -rl 40960 -bs 1 -df ${APP_DATA_DIR} -gd 0 -k 1 -p 1 -l /projects/datascience/dhari/tf_logs/cosmic_tr_${i})
  else
    data_type=hdf5_opt
    OPTS=(-f ${data_type} -fa shared -nf 1 -sf 3072000 -rl 40960 -bs 1 -df ${APP_DATA_DIR} -ts 1048576 -tr ${i} -rp 1 -ps 3072000 -gd 0 -k 1 -p 1 -l /projects/datascience/dhari/tf_logs/cosmic_tr_${i})
  fi
  n=128
