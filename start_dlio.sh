...
docker run -it --rm --name=$container_name --ipc=host -v $DATA_DIR:/workspace/dlio/data -v $OUTPUT_DIR:/workspace/dlio/output dlio:loic /bin/bash run_dlio_pt.sh $num_gpus $generate_data
