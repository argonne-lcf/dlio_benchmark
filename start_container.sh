...
docker run -it --rm --name=train_dlio_pt --gpus all -v /dl-bench/lhovon/dlio_benchmark/data:/workspace/dlio/data -v /dl-bench/lhovon/dlio_benchmark/output:/workspace/dlio/output dlio:pt /bin/bash
